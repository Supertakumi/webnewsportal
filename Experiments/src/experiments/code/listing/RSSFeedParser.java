...
//@SuppressWarnings("all")
  public Feed readFeed() throws UnsupportedEncodingException, IOException {
    Feed feed = null;
    try {
      ...
      //InputStream in = read();
      XMLEventReader eventReader = inputFactory.createXMLEventReader(new InputStreamReader(url.openStream(),"UTF8"));
