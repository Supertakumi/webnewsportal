...
<form action = "<portlet:actionURL/>" name="regForm" method="post"  onsubmit="return reg(this)" >
<div id="reg1" class="regclass1">
<center>
...
<tr>
	<td colspan="2" id="rf" class="rf"><b>Registration-Form</b></td>
</tr>
